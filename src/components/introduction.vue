<template>
    <div class="text-center">        
        ...
        <p>
            Created by <a href="http://emaps.charmeck.org" target="_blank"  rel="noopener">Mecklenburg County GIS</a><br>
        </p>
        <p>
        ...
        <p>
            With much <span style="font-size: 1.3em;">&#9829;</span> for the projects that make this site possible:<br>

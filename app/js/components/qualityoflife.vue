            ...
            chart: function() {
                ...
                if (_this.chartData && _this.chartData.years.length > 1) {
                    ...
                    if (_this.chartData.values[_this.neighborhoodCompare][_this.chartCompare]) {
                        data.series.push(_this.chartData.values[_this.neighborhoodCompare][_this.chartCompare].map(function(num) {
                            return parseFloat(num.replace(/[^0-9-.]/g, ''));
                        }));
                    } else {
                        data.series.push(_this.chartData.values['Jurisdiction']['County'].map(function(num) {
                            return parseFloat(num.replace(/[^0-9-.]/g, ''));
                        }));
                    }
                    // set selected series
                    if (_this.chartData.values.Neighborhood.length > 0) {
                        data.series.push(_this.chartData.values.Neighborhood.map(function(num) {
                            return parseFloat(num.replace(/[^0-9-.]/g, ''));
                        }));
                    }
...
<style lang="css">
    .qol-chart-trend .ct-series-b .ct-line,
